...
const Header = ({ isTopBar, variant }) => {
  ...
  const menu = useMemo(() => ({
    email: 'info@delbari.com.au',
    location: '123 Wedding Street, Love City, LC 12345',
    logoUrl: '/logo.png',
    logoLink: '/',
    navItems: [
      { label: 'Home', href: '/' },
              ...
              <div className="cs_top_header_in">
                ...
                <div className="cs_top_header_right">
                  <div className="cs_social_btns cs_style_1">
                    <Link href="https://www.facebook.com/profile.php?id=61579424798123&rdid=MndWMYpU1h5kpuNd&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1FDMpoRG4X%2F#" className="cs_center" target="_blank" rel="noopener noreferrer">
                      <i>
                        <FaFacebookF />
                      </i>
                    </Link>
                    <Link href="https://www.instagram.com/delbari_australia" className="cs_center" target="_blank" rel="noopener noreferrer">
                      <i>
                        <FaInstagram />
                      </i>
                    </Link>
