  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        form.identityDocument !== null &&
        form.identityDocument !== undefined
      ) {
      ...
      console.log("Submitting form with:", {
        ...
        profilePhotoSize:
          form.profilePhoto instanceof File ? form.profilePhoto.size : 0,
        identityDocumentSize:
          form.identityDocument instanceof File
            ? form.identityDocument.size
            : 0,
      });
    ...
    <div className="container-fluid g-0 bg-dark text-light min-vh-100">
      <div className="d-flex">
        ...
        <main className="flex-grow-1 p-4">
          ...
          <form
            className="card bg-black border-0 shadow-sm"
            onSubmit={onSubmit}
          >
                  ...
                  <div className="row g-3 mb-4">
                      ...
                      >
                        {imagePreview.profilePhoto ? (
                              ...
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  setImagePreview((prev) => ({
                                    ...prev,
                                    profilePhoto:
                                      originalImages.profilePhotoUrl || null,
                                  }));
                          ...
                          <div className="text-center">
                            <div className="mb-2">
                              <div
                                className="d-inline-flex align-items-center justify-content-center rounded-circle bg-secondary bg-opacity-25"
                    ...
                    <div className="col-md-6">
                      ...
                      >
                        ...
                        (form.identityDocument instanceof File &&
                          (form.identityDocument.type === "application/pdf" ||
                          ...
                          <div className="text-center">
                            ...
                            (originalImages.identityDocumentUrl &&
                              originalImages.identityDocumentUrl
                                ...
                                .includes("pdf")) ||
                            (imagePreview.identityDocument &&
                              !imagePreview.identityDocument.startsWith(
                                "data:",
                              ) &&
                              imagePreview.identityDocument
                                .toLowerCase()
