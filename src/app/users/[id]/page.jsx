        ...
        <main className="flex-grow-1 p-4">
          <div className="d-flex justify-content-between align-items-center mb-4">
            ...
            <div className="d-flex gap-2">
              ...
              <Link href={`/users/${userId}/edit`} className="btn btn-primary">
                Edit User
              </Link>
            </div>
          </div>
              ...
              <div className="card bg-black border-0 shadow-sm h-100">
                <div className="card-body">
                  ...
                  {(user.profilePhotoUrl || user.profilePhotoName) && (
                    <div className="mt-4">
                      <label className="text-light small mb-2 d-block fw-semibold">
                        Profile Photo
                      </label>
                      {user.profilePhotoUrl ? (
                        <div className="text-center">
                          <img
                            ...
                            onClick={() =>
                              window.open(user.profilePhotoUrl, "_blank")
                            }
                      ...
                      {user.identityDocumentUrl ? (
                        ...
                        user.identityDocumentUrl
                          ...
                          >
                            <div className="mb-3">
                              <div
                                className="d-inline-flex align-items-center justify-content-center rounded-circle bg-primary bg-opacity-25"
                          ...
                          <div className="text-center">
                            <img
                              ...
                              onClick={() =>
                                window.open(user.identityDocumentUrl, "_blank")
                              }
                              title="Click to view full size"
                            />
                            <div className="mt-2">
