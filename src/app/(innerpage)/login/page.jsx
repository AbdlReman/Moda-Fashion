  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        localStorage.setItem('userId', data.user.id?.toString() || String(data.user._id) || '');
        ...
        <div className="card shadow-lg border-0">
          <div className="card-body p-4 p-md-5">
            <div className="text-center mb-4">
              ...
              <div className="text-muted small mt-1">Log in to your account</div>
            </div>
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="d-flex align-items-center justify-content-between mb-3">
                ...
                <Link href="#" className="small text-primary">Forgot password?</Link>
              </div>
            ...
            <p className="text-center text-muted mt-3 mb-0">
              ...
              <Link href="/register" className="text-primary fw-medium">Register</Link>
            </p>
          </div>
        </div>
      </div>
